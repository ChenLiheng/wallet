...
public class MyWalletFile {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MyWalletFile)) {
            return false;
        }

        MyWalletFile that = (MyWalletFile) o;
    ...
    public static class Crypto {
        ...
        @JsonTypeInfo(
                ...
                property = "kdf")
        @JsonSubTypes({
                @JsonSubTypes.Type(value = Aes128CtrKdfParams.class, name = MyWallet.AES_128_CTR),
                @JsonSubTypes.Type(value = ScryptKdfParams.class, name = MyWallet.SCRYPT)
        })
